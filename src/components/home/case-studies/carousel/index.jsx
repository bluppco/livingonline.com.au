...
const CaseStudyCarousel = ( props ) => {
    ...
    return (
        <section className="w-full h-full relative">
            <div className="h-full flex items-center absolute top-0 -left-16" onClick={ prevSlide }>
            ...
            <div className="h-full flex items-center absolute top-0 -right-16" onClick={ nextSlide }>
                <div className="w-8 aspect-square cursor-pointer">
                    <PictureInternalContain
